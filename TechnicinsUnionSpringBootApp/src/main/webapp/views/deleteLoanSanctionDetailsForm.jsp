...
<title>Delete Loan Sanction Details</title>
...
<body>
	...
	<button onclick="topFunction()" id="myBtn" title="Go to top">Top</button>
		...
		<div class='mainbody'>
		<H1>Delete Loan Sanction Details</H1>
	...
	if(urlParams.deptId!=null&& urlParams.deptId!='undefined' && urlParams.deptId!=''
		...
		<input type="hidden" name="pageId" value="DELETE_LOAN_SANCTION" id="PAGE_ID">
		<input type="hidden" name="memberId"  value='${MEMBER_ID}' id="MEMBER_ID">
			...
			<div class="" id="membershipDeatils">
					...
					<fieldset>
						...
						<table>
							<form action="" method="get" onsubmit="" id="deleteLoanSanctionDetailsForm">
								
								<input type="hidden" name="cardNo"  value='${CARD_NO}' id="deleteLoanSanctionDetailsCardNo">
								<input type="hidden" name="deptId"  value='${DEPT_ID}' id="deleteoanSanctionDetailsDeptId">
								<input type='hidden' name='loanId' value='${LOAN_ID}' id='deleteLoanSanctionDetailsLoanId' >
						
								<tr>
									<td>Loan Sanctined Date</td>
									<td><input type='text' name='loanSanctionedDate' id='deleteLoanSanctionDateId' class='texBoxCss  form-control datepicker'  value='${LOAN_SANCTIONED_DATE}'></td>
									
								
									<td>Name</td>
									<td><input type='text' name='name' id='deleteLoanSanctionDetailsName' class='texBoxCss' value='${FIRST_NAME}'></td>
								</tr>
							
								
								<tr>
								<td>Father Name</td>
									<td><input type='text' name='name' id='deleteLoanSanctionDetailsFatherName' class='texBoxCss' value='${FATHER_NAME}' readonly></td>
								
								
									<td>LOAN AMOUNT</td>
									<td><input type='text' name='loanAmount' id='deleteLoanSanctionDetailsLoanAmount' class='texBoxCss' value='${LOAN_AMOUNT}'></td>
								</tr>
								...
								<tr>
									<td colspan="4" align="center"><button class="w3-button w3-white w3-border w3-border-blue" style="margin:5px;" id="deleteLoanSanctionDetailsBtn">Delete</button>
